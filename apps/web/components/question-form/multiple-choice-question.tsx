...
export const MultipleChoiceQuestion = ({
  ...
  const handleOptionPropertyChange = (
    index: number,
              ...
              <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
                {localOptions.map((option, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id={`exclusive-${option.id}`}
                        checked={option.isExclusive || false}
                        onCheckedChange={(checked) =>
                          handleOptionPropertyChange(
                            index,
                            "isExclusive",
                            checked as boolean,
                          )
                    ...
                    <div className="flex w-10 items-center justify-end relative">
                      <Checkbox disabled className="relative w-4 h-4" />
              ...
              {options.map((option, index) => (
                ...
                >
                  ...
                  <div className="rounded flex items-center px-2 py-0 relative flex-1 grow">
                    <Label
                      htmlFor={`${questionNumber}-${option.id}`}
